...
namespace Portfolio.Areas.Admin.Controllers
{
    ...
    public class EducationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Specialization,EducationName")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Specialization,EducationName")] Education education)
        {
            if (id != education.Id)
            {
                return NotFound();
