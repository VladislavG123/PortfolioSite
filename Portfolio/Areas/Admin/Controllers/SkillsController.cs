...
namespace Portfolio.Areas.Admin.Controllers
{
    ...
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SkillName,Percentage")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,SkillName,Percentage")] Skill skill)
        {
            if (id != skill.Id)
            {
                return NotFound();
